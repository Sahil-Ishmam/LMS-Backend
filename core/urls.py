...
from .views import category_list_create,course_list_create,course_detail,lesson_list_create,enrollment_list_create,material_list_create,questionanswer_list_create
urlpatterns = [
